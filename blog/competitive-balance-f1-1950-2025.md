...
predictable than in the past. Instead of relying on opinions, this project looks
at the data to understand how competitive Formula 1 has actually been over the
last 70+ years.
...
constructor, qualifying position, and race finishing position.

To keep results consistent across the full time period, the analysis focuses on
...
competitive balance is lower. If wins are spread across many teams, competition
is higher.

The results show that Formula 1 has experienced periods of strong dominance
throughout its history. While some seasons are relatively balanced, others are
clearly dominated by a single constructor. Importantly, this pattern is not
limited to recent years—dominance appears in early decades as well as in modern
eras.

Looking at the number of constructors that win at least one race in a season
provides a similar picture. Some seasons feature many race-winning teams, while
...
more difficult and race outcomes become more predictable.

To explore this, the analysis measures the relationship between qualifying
position and race finishing position over time. The results show a clear long-term
trend: qualifying position has become a stronger predictor of race outcomes in
recent decades.

In earlier years, race results were less closely tied to starting positions.
...
to show higher race outcome predictability based on qualifying performance.

This does not mean that races are always less exciting or that overtaking never
happens. Instead, it highlights a structural shift in how race results are
...
shows that dominance and predictability are recurring features of the sport, not
unique to any single era.

All code and figures used in this analysis are available in the accompanying
GitHub repository.
